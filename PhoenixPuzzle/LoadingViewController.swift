...
class LoadingViewController: UIViewController {
	...
	@IBOutlet weak var loadingProgressHUD: UIImageView!
...
//		progressHUD.startAnimating()
		loadingProgressHUD.isHidden = false
		loadingProgressHUD.rotate360Degrees()
...
//		progressHUD.stopAnimating()
		loadingProgressHUD.isHidden = true
		loadingProgressHUD.stopRotating()
		progressLabel.isHidden = true
	}
